...
def get_sample_file_dct(path, ext="*", identify_pairs=True):
    filenames = get_file_list(path, ext_mask=ext)
    return extract_sample_names_from_filenames(filenames, identify_pairs)
...
def extract_sample_names_from_filenames(filenames_lst, identify_pairs):
    """
    """
